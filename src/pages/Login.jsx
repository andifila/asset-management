    ...
    <div className="login-bg">
      <div className="login-card">
        ...
        <div className="login-features">
          ...
          <div className="feature-item"><span className="feature-dot" />Akses dari device manapun</div>
          <div className="feature-item"><span className="feature-dot" />Privat — hanya kamu yang bisa akses</div>
        </div>
        ...
        <p className="login-note">
          Hanya akun Google kamu yang bisa mengakses data ini.
        </p>
      </div>
    </div>
  )
